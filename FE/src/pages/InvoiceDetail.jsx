  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <header className="flex flex-col md:flex-row justify-between items-start mb-8 border-b pb-6">
          <div>
            <h1 className="text-4xl font-bold text-gray-800">Invoice</h1>
            <p className="text-gray-500">Invoice #{invoice.metadata.number}</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mb-8">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p>GSTIN: {invoice.parties.customer.taxInfo?.gstin || "N/A"}</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg">
            <h2 className="text-xl font-semibold border-b pb-2 mb-4">
              Details
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold mb-4">Line Items</h2>
        ...
        <div className="mt-8 flex justify-end">
          <div className="w-full md:w-1/3">
            ...
            <DetailItem
              ...
              value={`${
                invoice.metadata.currency
              } ${invoice.amounts.tax.total.toFixed(2)}`}
            />
            <div className="py-2 flex justify-between border-t-2 border-gray-800 mt-2 pt-2">
